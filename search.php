...
<html>
    ...
    <body>
        ...
        <div> 
            <button><a href="mainn.php">Înapoi</a></button>
			<button><a href="form.php">Sugerează un eveniment</a></button>
			
            <form method="POST" action="search.php">
                <p>Caută un eveniment</p>

                <label for="year">Alegeți anul:</label>
                ...
                <label for="month">Alegeți luna:</label>
                ...
                <label for="day">Alegeți ziua:</label>
...
<?php
    ...
    if (isset($_POST['year']) && isset($_POST['month']) && isset($_POST['day'])) {
                ...
                if ( ($year=='-') && ($month=='-') && ($day=='-') ) { #Dacă data rămâne default trece prin if-ul acesta
                    echo "Nu a fost găsit nici-un eveniment care sa corespundă datei introduse!";
                	...
                	$sql = "SELECT numeleEvenimentului, dataEveniment, descriereEveniment
                        FROM events
                        WHERE YEAR(dataEveniment) = '$year' AND MONTH(dataEveniment) = '$month' AND DAY(dataEveniment) = '$day'";
